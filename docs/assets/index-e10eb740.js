...
<html lang="en">
  ...
  <body>
    ...
    <script type="module">
      ...
      import { PlaygroundSandbox } from 'https://esm.sh/react-playground-test@#version#'
      ...
      const App = () => {
        ...
        return sandboxProps
          ? React.createElement(
              React.StrictMode,
              null,
              React.createElement(PlaygroundSandbox, sandboxProps)
            )
          : null
      }
...
`,L="react-playground-test",A="",I="0.0.3",F={".":{import:{types:"./dist/@types/Playground/index.d.ts",default:"./dist/index.mjs"}},"./PlaygroundSandbox":{import:{types:"./dist/@types/Playground/PlaygroundSandbox.d.ts",default:"./dist/PlaygroundSandbox.mjs"}}},M=["dist/*"],B={type:"git",url:"https://github.com/jialuyi/react-playground-test2.git"},U=["react","react-playground","playground","react-live","live-editor","codeSandbox","sandbox","live"],C="fewismuch",k="MIT",X={dev:"vite",build:"vite build && tsc",docs:"vite build && tsc",preview:"vite preview",prepare:"husky install",report:"tsc && vite build",prepublish:"npm run docs && npm run build && npm publish"},T={"@babel/standalone":"^7.23.1","@monaco-editor/react":"^4.5.2","@typescript/ata":"^0.9.4",allotment:"^1.19.3",classnames:"^2.3.2",fflate:"^0.8.1","file-saver":"^2.0.5",jszip:"^3.10.1","monaco-editor":"^0.43.0","monaco-jsx-syntax-highlight":"^1.2.0",react:"^18.2.0","react-copy-to-clipboard":"^5.1.0","react-dom":"^18.2.0"},$={react:">=18.2.0","react-dom":">=18.2.0"},H={"@types/babel__standalone":"^7.1.5","@types/file-saver":"^2.0.5","@types/node":"^20.8.10","@types/react":"^18.2.15","@types/react-dom":"^18.2.7","@typescript-eslint/eslint-plugin":"^6.8.0","@typescript-eslint/parser":"^6.8.0","@vitejs/plugin-react-swc":"^3.3.2",eslint:"^8.45.0","eslint-config-prettier":"^9.0.0","eslint-config-standard":"^17.1.0","eslint-plugin-import":"^2.28.1","eslint-plugin-n":"^16.2.0","eslint-plugin-prettier":"^5.0.1","eslint-plugin-promise":"^6.1.1","eslint-plugin-react":"^7.33.2","eslint-plugin-react-hooks":"^4.6.0","eslint-plugin-react-refresh":"^0.4.3","eslint-plugin-standard":"^5.0.0",husky:"^8.0.3",less:"^4.1.3","less-loader":"^11.1.2","lint-staged":"^15.0.2",prettier:"^3.0.3","rollup-plugin-visualizer":"^5.9.2",stylelint:"^15.11.0","stylelint-config-css-modules":"^4.3.0","stylelint-config-prettier":"^9.0.5","stylelint-config-recommended-less":"^2.0.0","stylelint-config-standard":"^34.0.0","stylelint-less":"^2.0.0","stylelint-order":"^6.0.3","stylelint-prettier":"^4.0.2",typescript:"^5.0.2",vite:"^4.4.5","vite-plugin-cdn-import":"^0.3.5","vite-plugin-css-injected-by-js":"^3.3.0"},V={name:L,description:A,private:!1,version:I,exports:F,files:M,repository:B,keywords:U,author:C,license:k,scripts:X,dependencies:T,peerDependencies:$,devDependencies:H,"lint-staged":{"src/**/*.{js,jsx,ts,tsx}":["eslint --max-warnings 0"],"src/**/*.{css,less,scss}":["stylelint --max-warnings 0"]}},W=n=>{const t="//unpkg.com/es-module-shims@1.8.0/dist/es-module-shims.js",i=typeof import.meta>"u"?n.replace("<!-- es-module-shims -->",`<script async src="${t}"><\/script>`):n;return URL.createObjectURL(new Blob([i],{type:"text/html"}))},q=N.replace("#version#",V.version),z=W(q)+window.location.hash,G=n=>{const{width:t="100vw",height:i="100vh"}=n,r=React.useRef(null),e=React.useRef(!1),[s,a]=React.useState(!1),c=React.useRef(null),b=o=>{o.forEach(l=>{l.isIntersecting&&a(!0)})},m=o=>{var f,y,g;const{type:l,message:R}=o.data;l==="SANDBOX_LOADED"?((y=(f=r.current)==null?void 0:f.contentWindow)==null||y.postMessage({type:"SANDBOX_RUN",data:{...n,onFilesChange:void 0}}),e.current=!0):l==="SANDBOX_ON_FILES_CHANGE"&&((g=n.onFilesChange)==null||g.call(n,R))};return React.useEffect(()=>{const o=new IntersectionObserver(b,{threshold:.2});return c.current&&o.observe(c.current),()=>{c.current&&o.unobserve(c.current)}},[]),React.useEffect(()=>(window.addEventListener("message",m),()=>{window.removeEventListener("message",m)}),[]),React.useEffect(()=>{var o,l;e.current&&((l=(o=r.current)==null?void 0:o.contentWindow)==null||l.postMessage({type:"SANDBOX_RUN",data:{...n,onFilesChange:void 0}}))},[n]),d.jsx("div",{ref:c,style:{width:t,height:i},children:s?d.jsx("iframe",{ref:r,src:z,style:{width:"100%",height:"100%",padding:0,border:"none"},sandbox:"allow-popups-to-escape-sandbox allow-scripts allow-popups allow-forms allow-pointer-lock allow-top-navigation allow-modals allow-same-origin"}):null})},J=G;function K(){const n=t=>{window.location.hash=t};return d.jsx(J,{onFilesChange:n})}u.createRoot(document.getElementById("root")).render(d.jsx(K,{}));
